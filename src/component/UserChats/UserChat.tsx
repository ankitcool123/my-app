                  ...
                  <div className="col-sm-4 ">
                    <div className="card picStyle">
                      <div className="card picStyle2">
                        <img
                          src={
                            state.user.photoUrl ? state.user.photoUrl : myImg
                          }
                          className="card-img-top pivStyle1"
                          alt="image"
                        />
                      </div>
                      ...
                      <div className="marginL">
                        <h5> Location : </h5>{" "}
                        {state.user.country ? state.user.country : "Bhopal"}
                      </div>
                      <div className="marginL">
                      ...
                      <div className="marginL">
                        <h5> Last active: </h5>{" "}
                        {new Date(state.user.lastActive).toLocaleString()}
                      </div>
                      ...
                      <div className="card-body">
                        <h5 className="card-title">
                          ...
                          <div className="tab-content" id="nav-tabContent">
                            ...
                            >
                              <Messages data={state.user.userName} />
                            </div>
                            <div
