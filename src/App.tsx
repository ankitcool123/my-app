...
function App() {
  ...
  return (
   <BrowserRouter>
      <RecoilRoot>
        <Routes>
          <Route path="/" element={<Login setSignIn={setSignIn} />} />
          <Route path="/Register" element={<SignUp />} />
          <Route element={<Layout />}>
            <Route path="/Dashborad" element={<Protected Component={Welcome} />} />
            <Route path="/Dashborad/Contact" element={<Protected Component={Contact} />} />
            <Route path="/Dashborad/Chat" element={<Protected Component={Chat} />} />
            <Route path="/Dashborad/Status" element={<Protected Component={Status} />} />
            <Route path="/Dashborad/EditUserProfile" element={<Protected Component={EditUserProfile} />} />
            <Route path="/Dashborad/Contact/UserChat" element={<Protected Component={UserChat} />} />
          </Route>
        </Routes>
      </RecoilRoot>
    </BrowserRouter>
